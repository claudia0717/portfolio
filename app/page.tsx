  ...
  return (
    <>
      <main className="flex-1">
        <HeroVideo
        webm="/videos/hero.webm"  // 1순위 (크롬/엣지/안드 대부분)
        mp4="/videos/hero.mp4"    // 2순위 (사파리/구형 브라우저 대비)
      />
        ...
        {/* === PUBLISHER === */}
        <section id="publisher" className="w-full bg-white text-[#15377e] py-0">
          <div className="px-0">
            <div className="grid grid-cols-12 bg-[#15377e] gap-[2px] items-stretch">
              {/* 왼쪽 타이틀 */}
              ...
              <div className="col-span-12 md:col-span-8 bg-white">
                <div className="grid grid-cols-2 gap-[2px] bg-[#15377e]">
        ...
        <section
          id="uxui"
          className="w-full bg-[#15377e] text-white pt-48 md:pt-72 pb-28 overflow-x-clip"
        >
        ...
        {/* === RESUME === */}
        <section id="resume" className="w-full bg-[#15377e] text-[#f3c530]">
          <div className="min-h-[100dvh] flex items-center justify-center px-6">
            <div className="w-fit text-center">
              ...
              <a
                ...
                className="mt-10 inline-block px-10 md:px-14 py-4 rounded-full bg-[#f3c530] text-[#15377e] font-semibold tracking-wide uppercase transition hover:bg-white hover:text-[#15377e] focus:outline-none focus-visible:ring-4 focus-visible:ring-white/30"
              >
                OPEN RESUME
              </a>
            </div>
